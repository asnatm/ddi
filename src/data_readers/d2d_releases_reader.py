...
from src.data_readers.d2d_preprocess import drugs_preproc
from src.data_readers.dataset_dates import d2d_versions_metadata
from src.utils import unpickle_object, pickle_object
...
class d2d_releases_reader:
    ...
    def __init__(self,force_read_file=False):
        self.force_read = force_read_file
        pass

    def read_and_preproc_release(self, version =''):
